...
*** appearence
    ...
    ;; badwolf theme set outline-1 face (inherited by org-level-1) of height 1.2, use 1.0 to reset it
    (set-face-attribute 'org-level-1 nil :underline nil :foreground "#2a9d8f" :slant 'normal :weight 'bold :height 1.0)
    ...
    (set-face-attribute 'org-todo nil :underline nil :foreground "#b23a48" :slant 'normal :weight 'bold :box t)
    (set-face-attribute 'org-done nil :underline nil :foreground "#461220" :slant 'normal :weight 'bold :box t)
