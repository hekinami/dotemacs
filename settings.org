...
*** package.el
    ...
    | melpa-stable-cn | http://elpa.emacs-china.org/stable-melpa/      |
...
*** editing
    ...
    (use-package org-fragtog
      ...
      :config
      (setq org-preview-latex-process-alist '((imagemagick :programs ("xelatex" "convert") :description "pdf > png"
...
*** org-roam
    ...
    (use-package org-roam
      ...
      :custom
      (org-roam-directory (file-truename (locate-contents-file "organizer/roam/")))
      :bind (("C-c n r l" . org-roam-buffer-toggle)
             ...
             ("C-c n r n" . notdeft)
             ("C-c n r r r" . org-roam-ref-add)
             ("C-c n r r R" . org-roam-ref-remove)
             ("C-c n r r a" . org-roam-alias-add)
             ("C-c n r r A" . org-roam-alias-remove)
             ("C-c n r r i" . org-id-get-create)
             ;; Dailies
             ("C-c n r d g d" . org-roam-dailies-goto-date)
             ("C-c n r d g n" . org-roam-dailies-goto-next-note)
             ("C-c n r d g p" . org-roam-dailies-goto-previous-note)
             ("C-c n r d g t" . org-roam-dailies-goto-today)
             ("C-c n r d g y" . org-roam-dailies-goto-yesterday)
    ...
    #+begin_src emacs-lisp
    (use-package org-roam-ui :quelpa (org-roam-ui :fetcher github :repo "org-roam/org-roam-ui" :files ("*.el" "out"))
      :config
